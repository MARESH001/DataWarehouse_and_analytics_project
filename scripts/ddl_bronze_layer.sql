...
--Script is to  crate table, remmber to add trucate to avoide duplicate data upon reloading and also rerunning this will drop existing table and create new one on bronze schema
